...
import com.luck.picture.selector.engine.CacheResourcesEngine;
import com.luck.picture.selector.engine.CompressEngine;
import com.luck.picture.selector.engine.ImageEngine;
import com.luck.picture.selector.entity.LocalMedia;
import com.luck.picture.selector.listener.OnChooseLimitCallback;
import com.luck.picture.selector.listener.OnCustomCameraInterfaceListener;
...
import com.luck.picture.selector.style.PictureCropParameterStyle;
import com.luck.picture.selector.style.PictureParameterStyle;
...
public class PictureSelectionModel {
    ...
    public PictureSelectionModel setAddType(int type) {
        selectionConfig.mAddFileType = type;
        return this;
    }
     ...
     *                           Use {@link Bitmap.CompressFormat | Bitmap.CompressFormat.PNG  | Bitmap.CompressFormat.WEBP_LOSSLESS}
     * @return
     */
    ...
    /**
     * Extra used with {@link #+  File.separator + "CustomCamera" + File.separator}  to indicate that
     *
        ...
        if (!DoubleUtils.isFastDoubleClick()) {
            ...
            if (selectionConfig.camera && selectionConfig.isUseCustomCamera) {
                ...
                intent = new Intent(activity, selectionConfig.camera
                        ...
                        selectionConfig.isWeChatStyle ? PictureSelectorWeChatStyleActivity.class
                                : PictureSelectorActivity.class);
                intent.putExtra(PictureConfig.EXTRA_ADD_FILE_TYPE, selectionConfig.mAddFileType);
            }
            Fragment fragment = selector.getFragment();
            if (fragment != null) {
     ...
     * @param medias
     */
    public void openExternalPreview(int position, View view, List<LocalMedia> medias) {
        if (selector != null) {
            selector.externalPicturePreview(position, view, medias, PictureSelectionConfig.windowAnimationStyle.activityPreviewEnterAnimation);
        } else {
