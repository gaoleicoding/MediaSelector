...
public final class PictureSelector {
     ...
     * @param medias
     */
    public void externalPicturePreview(int position, View view, List<LocalMedia> medias, int enterAnimation) {
        if (!DoubleUtils.isFastDoubleClick()) {
            if (getActivity() != null) {
                ...
                ActivityOptionsCompat optionsCompat =
                        ActivityOptionsCompat.makeSceneTransitionAnimation(getActivity(), view, medias.get(position).getRealPath());
