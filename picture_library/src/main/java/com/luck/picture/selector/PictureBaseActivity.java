...
import com.luck.picture.selector.compress.Luban;
import com.luck.picture.selector.compress.OnCompressListener;
...
import com.luck.picture.selector.dialog.PictureLoadingDialog;
...
import com.luck.picture.selector.immersive.NavBarUtils;
import com.luck.picture.selector.language.PictureLanguageUtils;
...
import com.luck.picture.selector.tools.AndroidQTransformUtils;
...
//            startActivityForResult(cameraIntent, PictureConfig.REQUEST_CAMERA);
            ...
            if (!FastClickUtil.isFastClickActivity(AliyunVideoRecorder.class.getSimpleName())) {
                AliyunVideoRecorder.startRecordForResult(this, PictureConfig.REQUEST_ALIYUN_RECORD, recordParam);
            }
        }
    }
